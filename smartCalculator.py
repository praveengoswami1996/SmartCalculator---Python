responses=["Welcome to Smart Calculator","My Name is Calco","Thanks",
           "Sorry, this is beyond my ability"] #A List containing some responses
...
operations={"PLUS":add, "ADD":add, "ADDITION":add, "SUM":add,
            ...
            "DIVIDE":division, "DIVISION":division, "LCM":lcm,
            "HCF":hcf, "BIG":big, "MAX":big, "GREATER":big
            }
